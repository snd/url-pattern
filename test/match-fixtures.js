...
test('match', function(t) {
  ...
  pattern = new UrlPattern('/admin(/:foo)/bar')
  t.deepEqual(pattern.match('/admin/baz/bar'), {foo: 'baz'})
  t.deepEqual(pattern.match('/admin/bar'), {})

  pattern = new UrlPattern('/admin/(*/)foo')
  t.deepEqual(pattern.match('/admin/foo'), {})
  t.deepEqual(pattern.match('/admin/baz/bar/biff/foo'), {_: 'baz/bar/biff'})
  ...
  t.deepEqual(pattern.match('/a_bar'), {foo: 'a'})
  t.deepEqual(pattern.match('/a__bar'), {foo: 'a_'})
  t.deepEqual(pattern.match('/a-b-c-d__bar'), {foo: 'a-b-c-d_'})
  t.deepEqual(pattern.match('/a b%c-d__bar'), {foo: 'a b%c-d_'})
  ...
  t.deepEqual(pattern.match('/user/10-20'), {range: '10-20'})

  pattern = new UrlPattern('/user/:range')
  t.deepEqual(pattern.match('/user/10_20'), {range: '10_20'})
  ...
  t.equal(null, pattern.match('/ip/10.'))
  t.equal(null, pattern.match('/ip/'))
  t.deepEqual(pattern.match('/ip/10.10.10.10'), {ip: '10.10.10.10'})
  t.deepEqual(pattern.match('/ip/127.0.0.1'), {ip: '127.0.0.1'})
