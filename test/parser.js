...
test('fixtures', function(t) {
  ...
  t.deepEqual(parse('(foo))'), {
    rest: ')',
    value: [{tag: 'optional', value: [{tag: 'static', value: 'foo'}]}]
  })
  ...
  t.deepEqual(parse('foo:*'), {
    rest: ':*',
    value: [{tag: 'static', value: 'foo'}]
  })

  t.deepEqual(parse(':foo:bar'), {
    rest: '',
    value: [{tag: 'named', value: 'foo'}, {tag: 'named', value: 'bar'}]
  })

  t.deepEqual(parse('a'), {
    rest: '',
    value: [{tag: 'static', value: 'a'}]
  })
  t.deepEqual(parse('user42'), {
    rest: '',
    value: [{tag: 'static', value: 'user42'}]
  })
  t.deepEqual(parse(':a'), {
    rest: '',
    value: [{tag: 'named', value: 'a'}]
  })
  t.deepEqual(parse('*'), {
    rest: '',
    value: [{tag: 'wildcard', value: '*'}]
  })
  t.deepEqual(parse('(foo)'), {
    rest: '',
    value: [{tag: 'optional', value: [{tag: 'static', value: 'foo'}]}]
  ...
  t.deepEqual(parse('(:foo)'), {
    rest: '',
    value: [{tag: 'optional', value: [{tag: 'named', value: 'foo'}]}]
  })
  t.deepEqual(parse('(*)'), {
    rest: '',
    value: [{tag: 'optional', value: [{tag: 'wildcard', value: '*'}]}]
  })

  t.deepEqual(parse('/api/users/:id'), {
    rest: '',
    value: [{tag: 'static', value: '/api/users/'}, {tag: 'named', value: 'id'}]
  })
  t.deepEqual(parse('/v:major(.:minor)/*'), {
    ...
    value: [
      ...
      {
        tag: 'optional',
        value: [{tag: 'static', value: '.'}, {tag: 'named', value: 'minor'}]
      },
      {tag: 'static', value: '/'},
      {tag: 'wildcard', value: '*'}
    ]
  ...
  t.deepEqual(parse('(http(s)\\://)(:subdomain.):domain.:tld(/*)'), {
    ...
    value: [
      ...
      {
        tag: 'optional',
        value: [{tag: 'named', value: 'subdomain'}, {tag: 'static', value: '.'}]
      },
      ...
      {
        tag: 'optional',
        value: [{tag: 'static', value: '/'}, {tag: 'wildcard', value: '*'}]
      }
    ]
  })
  ...
  t.deepEqual(parse('/admin*'), {
    rest: '',
    value: [{tag: 'static', value: '/admin'}, {tag: 'wildcard', value: '*'}]
  })
  ...
  t.deepEqual(parse('/*/admin(/:path)'), {
    ...
    value: [
      ...
      {
        tag: 'optional',
        value: [{tag: 'static', value: '/'}, {tag: 'named', value: 'path'}]
      }
    ]
  })
  ...
  t.deepEqual(parse('/admin(/:foo)/bar'), {
    ...
    value: [
      ...
      {
        tag: 'optional',
        value: [{tag: 'static', value: '/'}, {tag: 'named', value: 'foo'}]
      },
  ...
  t.deepEqual(parse('/admin(*/)foo'), {
    ...
    value: [
      ...
      {
        tag: 'optional',
        value: [{tag: 'wildcard', value: '*'}, {tag: 'static', value: '/'}]
      },
